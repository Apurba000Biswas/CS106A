/**File :GFaceUsingGCompound.java
 * ----------------------------------
 * this progam creates a graphical face using the GCompound class that
 * lives in the acm graphics package
 */
package Week04.Lect01;

import acm.graphics.*;

public class GFaceUsingGCompound extends GCompound{
	//constant defining
	...
	public GFaceUsingGCompound(double width, double height) {
	...
	/**private GPolygon createNose(double width,double height) method
	 * *************************************************************
